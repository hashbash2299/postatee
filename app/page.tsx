  ...
  return (
    <div className="min-h-screen bg-[#0B1418] text-white" dir="rtl">
      ...
      <nav className="lg:hidden fixed bottom-0 w-full bg-[#122025] border-t border-[#1A2E35] flex justify-around items-center py-2 z-50">
        <button className="flex flex-col items-center text-gray-400"><span className="text-xl">👤</span><span className="text-[10px]">الملف الشخصي</span></button>
        <button className="flex flex-col items-center text-gray-400"><span className="text-xl">🧭</span><span className="text-[10px]">اكتشف</span></button>
